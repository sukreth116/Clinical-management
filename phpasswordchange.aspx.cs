...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        cmd.Connection = con;
        cmd.CommandText = "select * from logintb where sid=" + Session["sid"].ToString() + "";
    ...
    {
        cmd.Connection = con;
        cmd.CommandText = "update  logintb set password='" + TextBox2.Text + "' where sid=" + Session["sid"].ToString();
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
