...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        cmd.Connection = con;
        cmd.CommandText = "select * from logintb where pid=" + Session["pid"].ToString() + "";
    ...
    {
        cmd.Connection = con;
        cmd.CommandText = "update  logintb set password='" + TextBox2.Text + "' where pid=" + Session["pid"].ToString();
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
